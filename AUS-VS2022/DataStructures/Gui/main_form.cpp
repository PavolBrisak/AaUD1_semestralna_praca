...
std::vector<std::unique_ptr<ds::utils::Analyzer>> createAnalyzers()
{
	...
	analyzers.emplace_back(std::make_unique<ds::utils::ListAccessAnalyzer<ds::adt::ImplicitList<int>>>("ImplicitList"));
	analyzers.emplace_back(std::make_unique<ds::utils::ListAccessAnalyzer<ds::adt::SinglyLinkedList<int>>>("SinglyLinkedList"));
