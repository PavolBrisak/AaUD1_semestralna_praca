...
namespace ds::amt {
	...
	public:
		...
		class MultiWayExplicitHierarchyIterator
		{
		public:
			MultiWayExplicitHierarchyIterator(Hierarchy<BlockType>* hierarchia, BlockType* vrchol);
			~MultiWayExplicitHierarchyIterator();
			void chodNaSyna(int sonIndex);
			void chodNaOtca();
			BlockType* dajAktualnyVrchol();
			DataType& dajData();
			PreOrderHierarchyIterator beginPreOrder();
			PreOrderHierarchyIterator endPreOrder();
			PostOrderHierarchyIterator beginPostOrder();
			PostOrderHierarchyIterator endPostOrder();
		private:
			BlockType* vrchol;
		...
		MultiWayExplicitHierarchyIterator beginMulti();
	...
	template <typename BlockType>
	Hierarchy<BlockType>::MultiWayExplicitHierarchyIterator::MultiWayExplicitHierarchyIterator(
		Hierarchy<BlockType>* hierarchia, BlockType* vrchol)
	{
		this->vrchol = vrchol;
		this->hierarchy = hierarchia;
	}
	...
	template <typename BlockType>
	void Hierarchy<BlockType>::MultiWayExplicitHierarchyIterator::chodNaSyna(int sonIndex)
	{
		this->vrchol = this->hierarchy->accessSon(*this->vrchol, sonIndex);
	}

	template <typename BlockType>
	void Hierarchy<BlockType>::MultiWayExplicitHierarchyIterator::chodNaOtca()
	{
		this->vrchol = this->hierarchy->accessParent(*this->vrchol);
	}

	template <typename BlockType>
	BlockType* Hierarchy<BlockType>::MultiWayExplicitHierarchyIterator::dajAktualnyVrchol()
	{
		return this->vrchol;
	}

	template <typename BlockType>
	typename Hierarchy<BlockType>::DataType& Hierarchy<BlockType>::MultiWayExplicitHierarchyIterator::dajData()
	{
		return this->vrchol->data_;
	}

	template <typename BlockType>
	typename Hierarchy<BlockType>::PreOrderHierarchyIterator Hierarchy<BlockType>::MultiWayExplicitHierarchyIterator::
	beginPreOrder()
	{
		return Hierarchy<BlockType>::PreOrderHierarchyIterator(this->hierarchy, this->vrchol);
	}
	...
	endPreOrder()
	{
		return Hierarchy<BlockType>::PreOrderHierarchyIterator(this->hierarchy, nullptr);
	}

	template <typename BlockType>
	typename Hierarchy<BlockType>::PostOrderHierarchyIterator Hierarchy<BlockType>::MultiWayExplicitHierarchyIterator::
	beginPostOrder()
	{
		return Hierarchy<BlockType>::PostOrderHierarchyIterator(this->hierarchy, this->vrchol);
	}
	...
	endPostOrder()
	{
		return Hierarchy<BlockType>::PostOrderHierarchyIterator(this->hierarchy, nullptr);
	}
	...
	template <typename BlockType>
	typename Hierarchy<BlockType>::MultiWayExplicitHierarchyIterator Hierarchy<BlockType>::beginMulti()
	{
		return MultiWayExplicitHierarchyIterator(this, this->accessRoot());
	}
